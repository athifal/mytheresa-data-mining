...
class MyTheresaSpider(scrapy.Spider):
    ...
    def parse_product(self, response):
        ...
        product_data = {
            ...
            "offer_price": None,  # Assuming no discount for now
            "discount": None,  # Assuming no discount info available
        ...
        # Optionally, yield the product data for storing in output files (e.g., JSON)
